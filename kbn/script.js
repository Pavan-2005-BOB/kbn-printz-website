...
document.addEventListener('DOMContentLoaded', function() {
    console.log('KBN Printz Store - Enhanced script loaded!');
    ...
    class ShoppingCart {
        ...
        addItem(product) {
            ...
            const existingIndex = this.items.findIndex(item => 
                ...
                this.isSameImage(item.image, product.image)
            );
            
            if (existingIndex > -1) {
                this.items[existingIndex].quantity += product.quantity;
                this.showNotification(`Updated quantity of ${product.name} in cart`, 'success');
            } else {
        ...
        isSameImage(img1, img2) {
            ...
            // Simple comparison for data URLs
            return img1.substring(0, 100) === img2.substring(0, 100);
        }
